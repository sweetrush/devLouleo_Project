...
// NOTE THIS FILE IS NOTE BEEN USED 
...
// Main Content 
page_header('Processing New Message Post');
...
$MessageID =  date("Ynd").''.date("his").rand();
 ...
 ////////////////////////////////////////////////////////////// 
 $SendnewMessagetoPool = '<div class="alert alert-success" role="alert">
  <h4 class="alert-heading">TFD : '.$TFD_TopicID.'</h4>
  <p>'.$TFD_DisReM.'</p>
  <hr>
  <p class="mb-0">
    <span class="badge bg-primary"> '.$TFD_CatType.'</span>
...
$MessageFileStore = fopen($TFD_TopicID.".messages","a") or die("Unable to open file!");
