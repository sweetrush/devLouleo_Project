...
page_header('Provide New Message on Topic ID:'.$topicID.' RefName: '.$topicStr.'');
...
<form action="./ppzProcessNewMessagesTopic.php" method="POST">
...
<div class="form-group">
  ...
  <textarea name="iTFD_item0006" class="form-control" id="editor" rows="5"></textarea>
  <script>
    tinymce.init({
      selector: \'textarea\',
